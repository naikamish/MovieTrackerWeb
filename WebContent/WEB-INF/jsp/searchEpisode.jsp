...
<title>Insert title here</title>
	...
	<script src="<c:url value="/resources/js/searchShow.js" />"></script>
...
<div class="modal fade" id="addShow" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form:form method="POST" action="/MovieTracker/addShow" class="form-horizontal" role="form">
